...
class FrozenBatchNorm2d(torch.nn.Module):
    ...
    Copy-paste from torchvision.misc.ops with added eps before rqsrt, without which any other
    policy_models than torchvision.policy_models.resnet[18,34,50,101] produce nans.
    """
...
class Joiner(nn.Sequential):
    def __init__(self, backbone, position_embedding, input_rgbd=False):
